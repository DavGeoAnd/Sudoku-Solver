...
public class Main {
	...
	public static void main(String[] args) {
		...
		// timedSolve(new Sudoku(2, new int[][] { new int[] { 0, 1, 0, 4 }, new
		// int[] { 0, 0, 0, 0 },
		// new int[] { 2, 0, 3, 0 }, new int[] { 0, 0, 0, 0 } }));
	...
	/**
	 * Solve a puzzle loaded from a file and display the solution and the time
	 * it took.
	 * 
	 * @param dim
	 *            dimension of puzzle
	 * @param filename
	 *            name of puzzle file to load
	 */
